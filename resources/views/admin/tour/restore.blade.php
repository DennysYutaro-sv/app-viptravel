        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0"><i class="fas fa-edit"></i> ¿Estás seguro de que desea restaurar esté tour?</h6>
              <p class="text-white">Si restaura el tour, entonces el tour se visualizara en la pagina web principal.</p>
            </div>
          </div>
          <!-- Card stats -->
          <div class="row">
              ...
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <form data-url="{{ route('tour.restore') }}" id="formRestore" method="POST">
                    @csrf
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                              <button class="btn btn-icon btn-success btn-block" type="submit" href="{{route('tour.restore')}}">
                                <span class="btn-inner--icon"><i class="fas fa-trash-restore"></i> Restaurar tour</span>
                              </button>
                            </div>
                            <div class="form-group col-6">
                              <a class="btn btn-icon btn-info btn-block" type="button" href="{{route('tour.trashed')}}">
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data != "") {
                ...
                $.toast({
                    text: 'El tour ha sido restaurado correctamente.',
                    showHideTransition: 'slide',
                    bgColor: '#629B58',
                    allowToastClose: false,
                    hideAfter: 4000,

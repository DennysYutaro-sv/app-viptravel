...
<div class="slider-destino">
    ...
    <div class="myslide-destino">
        <div class="txt-destino fade-destino">
            <h3>Machupicchu</h3>
            <p> “Nuestra maravilla del mundo”. </p>
        </div>
        <img class="img-slide-destino" src="{{asset('landing/assets/img/destination/2.jpg')}}"  style="width: 100%; height: 100%;">
    </div>
</div>
...
<section class="packages" id="packages">
    ...
    <h1 class="heading">
        <span>Nuestros tours en Machupicchu</span>
    </h1>
    <br>
    <br>

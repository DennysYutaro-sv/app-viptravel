...
<div class="slider-destino">
    ...
    <div class="myslide-destino">
        <div class="txt-destino fade-destino">
            <h3>Lima</h3>
            <p> “Playas, deportes de aventura y exquisita gastronomía encuentras en la capital del Perú”. </p>
        </div>
        <img class="img-slide-destino" src="{{asset('landing/assets/img/destination/3.jpg')}}"  style="width: 100%; height: 100%;">
    </div>
</div>
...
<section class="packages" id="packages">
    ...
    <h1 class="heading">
        <span>Nuestros tours en Lima</span>
    </h1>
    <br>
    <br>

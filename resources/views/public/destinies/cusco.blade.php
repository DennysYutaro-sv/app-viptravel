...
<div class="slider-destino">
    ...
    <div class="myslide-destino">
        <div class="txt-destino fade-destino">
            <h3>Cusco</h3>
            <p> “La capital historica del Perú”. </p>
        </div>
        <img class="img-slide-destino" src="{{asset('landing/assets/img/destination/1.jpg')}}"  style="width: 100%; height: 100%;">
    </div>
</div>
...
<section class="packages" id="packages">
    ...
    <h1 class="heading">
        <span>Nuestros tours en Cusco</span>
    </h1>
    <br>
    <br>

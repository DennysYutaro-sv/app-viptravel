...
<div class="slider-destino">
    ...
    <div class="myslide-destino">
        <div class="txt-destino fade-destino">
            <h3 class="peque">Ica</h3>
            <br>
            <h3 class="peque">Nazca</h3>
            <p> “Descubre sus misteriosas y espectaculares culturas arqueológicas”. </p>
        </div>
        <img class="img-slide-destino" src="{{asset('landing/assets/img/destination/5.jpg')}}"  style="width: 100%; height: 100%;">
    </div>
</div>
...
<section class="packages" id="packages">
    ...
    <h1 class="heading">
        <span>Nuestros tours en Ica-Nazca</span>
    </h1>
    <br>
    <br>

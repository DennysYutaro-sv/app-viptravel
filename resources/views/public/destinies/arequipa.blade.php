...
<div class="slider-destino">
    ...
    <div class="myslide-destino">
        <div class="txt-destino fade-destino">
            <h3>Arequipa</h3>
            <p> “Es un lugar para quedarse por su comida, por su historia y por su majestuosa cordialidad”. </p>
        </div>
        <img class="img-slide-destino" src="{{asset('landing/assets/img/destination/4.jpg')}}"  style="width: 100%; height: 100%;">
    </div>
</div>
...
<section class="packages" id="packages">
    ...
    <h1 class="heading">
        <span>Nuestros tours en Arequipa</span>
    </h1>
    <br>
    <br>
